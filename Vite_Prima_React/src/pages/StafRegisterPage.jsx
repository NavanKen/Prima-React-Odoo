...
import { registerStaf } from "../api/odoo";
import FormInput from "../components/FormInput";

const StafRegisterPage = () => {
            ...
            <div className="p-8">
              <motion.div variants={itemVariants} className="mb-8 text-center">
                ...
                <p className="text-gray-600">
                  Isi formulir di bawah ini untuk mendaftar sebagai staf
                </p>
              </motion.div>
                ...
                >
                  <Link to="/register">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="button"
                      className="flex items-center justify-center w-full px-6 py-3 text-purple-600 transition-all border border-purple-600 rounded-full sm:w-auto hover:bg-purple-50"
                    >
                      <svg
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="flex items-center justify-center w-full px-8 py-3 text-white transition-all rounded-full shadow-md sm:w-auto bg-gradient-to-r from-purple-600 to-purple-500 hover:shadow-lg disabled:opacity-70"
...
export default StafRegisterPage;
