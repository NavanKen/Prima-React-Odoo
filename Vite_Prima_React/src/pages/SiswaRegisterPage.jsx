...
import { registerSiswa } from "../api/odoo";
import FormInput from "../components/FormInput";

const SiswaRegisterPage = () => {
      ...
      try {
        ...
        if (result.success) {
          ...
          navigate("/register/success", {
            state: { type: "siswa", name: formData.name },
          });
        } else {
          // Navigasi ke halaman error jika gagal
          navigate("/register/error", {
            state: { error: result.error, type: "siswa" },
          });
        }
      } catch (error) {
  ...
  return (
    <div className="relative min-h-screen py-16 mt-5 overflow-hidden bg-gray-50">
      <div className="absolute rounded-full -top-40 -right-40 w-96 h-96 bg-purple-100/30 blur-3xl"></div>
            ...
            <div className="p-8">
              <motion.div variants={itemVariants} className="mb-8 text-center">
                ...
                <p className="text-gray-600">
                  Isi formulir di bawah ini untuk mendaftar sebagai siswa
                </p>
              </motion.div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <FormInput
                  ...
                  value={formData.umur}
                  onChange={handleChange}
                  placeholder="Umur akan dihitung otomatis"
                  readOnly={true}
                  errors={errors}
                />
                <FormInput
                ...
                >
                  <Link to="/register">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="button"
                      className="flex items-center justify-center w-full px-6 py-3 text-green-600 transition-all border border-green-600 rounded-full sm:w-auto hover:bg-purple-50"
                    >
                      <svg
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="flex items-center justify-center w-full px-8 py-3 text-white transition-all rounded-full shadow-md sm:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:shadow-lg disabled:opacity-70"
...
export default SiswaRegisterPage;
