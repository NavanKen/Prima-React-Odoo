...
const Footer = () => {
  ...
  return (
    <motion.footer
      className="relative py-12 overflow-hidden text-white bg-gradient-to-r from-gray-900 to-gray-800"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <div className="container relative z-10 px-4 mx-auto">
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <svg
                  ...
                  className="h-5 w-5 text-sky-400 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">info@primaodoo.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <motion.div
          ...
          className="pt-6 mt-10 text-center text-gray-400 border-t border-gray-700"
        >
          <p>
            &copy; {new Date().getFullYear()} PRIMA ODOO. All rights reserved.
          </p>
        </motion.div>
      </div>
    </motion.footer>
